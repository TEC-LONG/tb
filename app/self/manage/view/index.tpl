...
<!-- VENDOR CSS -->
<link rel="stylesheet" href="{logic_src(Config::C('URL'), 'self.share.vendor.bootstrap.css.bootstrap.min.css')}">
<!-- <link rel="stylesheet" href="{Config::C('URL')}/self/share/vendor/bootstrap/css/bootstrap.min.css"> -->
<link rel="stylesheet" href="https://www.jq22.com/jquery/font-awesome.4.7.0.css">
<link rel="stylesheet" href="{Config::C('URL')}/self/share/vendor/animate-css/vivify.min.css">

<link rel="stylesheet" href="{Config::C('URL')}/self/share/vendor/c3/c3.min.css"/>
<link rel="stylesheet" href="{Config::C('URL')}/self/share/vendor/chartist/css/chartist.css">
<link rel="stylesheet" href="{Config::C('URL')}/self/share/vendor/chartist-plugin-tooltip/chartist-plugin-tooltip.css">
<link rel="stylesheet" href="{Config::C('URL')}/self/share/vendor/toastr/toastr.min.css">
<link rel="stylesheet" href="{Config::C('URL')}/self/share/vendor/jvectormap/jquery-jvectormap-2.0.3.css"/>

<!-- MAIN CSS -->
<link rel="stylesheet" href="{Config::C('URL')}/self/share/css/site.css">
