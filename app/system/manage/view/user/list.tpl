...
<head>
<title>Brego | Table Normal</title>
<meta charset="UTF-8">
...
<link rel="stylesheet" href="{Config::C('URL')}/system/share/vendor/jquery-datatable/dataTables.bootstrap4.min.css">
<link rel="stylesheet" href="{Config::C('URL')}/system/share/vendor/jquery-datatable/fixedeader/dataTables.fixedcolumns.bootstrap4.min.css">
<link rel="stylesheet" href="{Config::C('URL')}/system/share/vendor/jquery-datatable/fixedeader/dataTables.fixedheader.bootstrap4.min.css">
<link rel="stylesheet" href="{Config::C('URL')}/system/share/vendor/sweetalert/sweetalert.css"/>
...
<div id="wrapper">
            ...
            <div class="navbar-right">
                <div id="navbar-menu">
                    <ul class="nav navbar-nav">
                        <li><a href="page-social.html" class="social icon-menu" title="News">Social</a></li>
                        <li><a href="page-news.html" class="news icon-menu" title="News">News</a></li>
    ...
    <div id="left-sidebar" class="sidebar">
        <div class="navbar-brand">
            <a href="index.html"><img src="assets/images/icon.svg" alt="Brego Logo" class="img-fluid logo"><span>Brego</span></a>
        ...
        <div class="sidebar-scroll">
            <div class="user-account">
                ...
                <a href="#" class="btn btn-sm btn-block btn-primary btn-round mt-3" title=""><i class="icon-plus mr-1"></i> Create New</a>
            </div>  
...
<script src="{Config::C('URL')}/system/share/bundles/datatablescripts.bundle.js"></script>
<script src="{Config::C('URL')}/system/share/vendor/jquery-datatable/buttons/dataTables.buttons.min.js"></script>
<script src="{Config::C('URL')}/system/share/vendor/jquery-datatable/buttons/buttons.bootstrap4.min.js"></script>
<script src="{Config::C('URL')}/system/share/vendor/jquery-datatable/buttons/buttons.colVis.min.js"></script>
<script src="{Config::C('URL')}/system/share/vendor/jquery-datatable/buttons/buttons.html5.min.js"></script>
<script src="{Config::C('URL')}/system/share/vendor/jquery-datatable/buttons/buttons.print.min.js"></script>
<script src="{Config::C('URL')}/system/share/vendor/sweetalert/sweetalert.min.js"></script><!-- SweetAlert Plugin Js --> 
<script src="{Config::C('URL')}/system/share/bundles/mainscripts.bundle.js"></script>
<script src="{Config::C('URL')}/system/share/js/pages/tables/jquery-datatable.js"></script>
</body>
</html>
