...
<link rel="stylesheet" href="{Config::C('URL')}/system/share/vendor/c3/c3.min.css"/>
<link rel="stylesheet" href="{Config::C('URL')}/system/share/vendor/chartist/css/chartist.css">
<link rel="stylesheet" href="{Config::C('URL')}/system/share/vendor/chartist-plugin-tooltip/chartist-plugin-tooltip.css">
<link rel="stylesheet" href="{Config::C('URL')}/system/share/vendor/toastr/toastr.min.css">
<link rel="stylesheet" href="{Config::C('URL')}/system/share/vendor/jvectormap/jquery-jvectormap-2.0.3.css"/>
...
<div class="page-loader-wrapper">
    <div class="loader">
        <div class="m-t-30"><img src="{Config::C('URL')}/system/share/images/logo.png" width="40" height="40" alt="Brego"></div>
        <p>Please wait...</p>        
    </div>
</div>
...
<div id="wrapper">
    ...
    <div id="left-sidebar" class="sidebar">
        <div class="navbar-brand">
            <a href="index.html"><img src="{Config::C('URL')}/system/share/images/logo1.png" alt="Brego Logo" class="img-fluid logo"><span>Tec-Long</span></a>
        ...
        <div class="sidebar-scroll">
            ...
            <nav id="left-sidebar-nav" class="sidebar-nav">
                <ul id="main-menu" class="metismenu">
                    ...
                    <li class="active">
                        <a class="has-arrow"><i class="icon-speedometer"></i><span>用户管理</span></a>
                        <ul>
                            <li class="active"><a href="index.html">用户列表</a></li>
                        </ul>
                    </li>
                    <li class="header">股票基金</li>
                    <li><a href="app-inbox.html"><i class="icon-envelope"></i> <span>每日新高</span> <span class="badge badge-default float-right mr-0">12</span></a></li>
                    <li><a href="app-chat.html"><i class="icon-bubbles"></i> <span>每日新低</span></a></li>
...
<script src="{Config::C('URL')}/system/share/vendor/toastr/toastr.js"></script>

<script src="{Config::C('URL')}/system/share/bundles/mainscripts.bundle.js"></script>
<script src="{Config::C('URL')}/system/share/js/index.js"></script>
</body>
</html>
